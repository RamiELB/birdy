...
public class Messages {
	...
	public static JSONObject get_msg_user(int id_user) throws JSONException{
		MongoDatabase db = Database.getMongoDBConnection();
		return tools.MessagesTools.get_msg_user(id_user, db);
	}
	
	public static JSONObject  get_replies(String idPere) throws JSONException{
		MongoDatabase db = Database.getMongoDBConnection();
		return tools.MessagesTools.get_replies(idPere, db);
	}
	
	public static JSONObject del_msg(String id_msg) throws JSONException {
		MongoDatabase db = Database.getMongoDBConnection();
